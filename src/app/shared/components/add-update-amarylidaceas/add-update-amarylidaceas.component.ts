...
@Component({
  selector: 'app-add-update-amarylidaceas',
  templateUrl: './add-update-amarylidaceas.component.html',
  styleUrls: ['./add-update-amarylidaceas.component.scss'],
})
export class AddUpdateAmarylidaceasComponent  implements OnInit {
  
  @Input() cultivos: AmarylidaceasM;
...
async updateCultivos() {
  ...
  let path =`/Amarylidáceas/${this.cultivos.aid}`
