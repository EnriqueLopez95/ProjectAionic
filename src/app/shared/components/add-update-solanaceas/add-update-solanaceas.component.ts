...
@Component({
  selector: 'app-add-update-solanaceas',
  templateUrl: './add-update-solanaceas.component.html',
  styleUrls: ['./add-update-solanaceas.component.scss'],
})
export class AddUpdatesolanaceasComponent  implements OnInit {
  
  @Input() cultivos: solanaceasM;
...
async updateCultivos() {
  ...
  let path =`/solanaceas/${this.cultivos.aid}`
