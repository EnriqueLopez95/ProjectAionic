...
@Component({
  selector: 'app-add-update-cucurbitaceas',
  templateUrl: './add-update-cucurbitaceas.component.html',
  styleUrls: ['./add-update-cucurbitaceas.component.scss'],
})
export class AddUpdateCucurbitaceasComponent  implements OnInit {

  @Input() cultivos: Curcuvitacias;
...
async updateCultivos() {
  ...
  let path =`/Curcubitaceas/${this.cultivos.aid}`
